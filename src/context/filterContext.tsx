...
export const FilterProvider = ({ children }: { children: Element }) => {
    ...
    const value = useMemo(() => ({
        charatersActiveName, setCharatersActiveName, charatersActiveStatus,
        ...
        clearFilter
    }), [charatersActiveName, charatersActiveStatus, charatersActiveGender, charatersActiveSpecies, locationsActiveName, locationsActiveType,
        locationsActiveDimension, episodesActiveName, episodesActiveEpisode]); 
